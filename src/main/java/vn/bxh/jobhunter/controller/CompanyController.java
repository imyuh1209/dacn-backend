...
public class CompanyController {
    ...
    public ResponseEntity<ResultPaginationDTO> getListCompanies(@RequestParam("current") Optional<String> currentOptional,
        ...
        return ResponseEntity.status(HttpStatus.ACCEPTED).body(this.companyService.FetchAllCompanies(pageable));
    }
